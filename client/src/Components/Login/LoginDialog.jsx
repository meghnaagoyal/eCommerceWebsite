            ...
            <DialogContent className={classes.component} >
                    {
                        ...
                        <Box className={classes.login}>
                            ...
                            <Typography className={classes.text}>By continuing, you agree to IVE's Terms of Use and Privacy Policy.</Typography>
                            <Button className={classes.loginbtn} onClick={() => loginUser()} >Login</Button>
            
                            
                            <Typography className={classes.createText} onClick={() => toggleSignup()}>New to IVE? Create an account</Typography>
                        </Box> : 
                        <Box className={classes.login}>
